...
printf "\n Nombre normalise (devrait etre le meme) : `wc -l < $moment/archipel-seq-acomparer`"
...
# .20160909.pn -> ajout du 15 pour le type de document
cat tous-dossier-pas-dans-archipel-avec-cour-guill | cut -d'|' -f2,6,7,9,12,14,15 > tous-dos-pas-ds-archi-a-cour-fituni
...
# .20160909.pn -> ajout du 9 pour le type de document
cat archipel-seq-acomparer | cut -d'|' -f2,3,4,5,6,7,8,9 > archipel-fituni
